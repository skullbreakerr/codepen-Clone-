      ...
      <div id="navigation-bar">
        <nav class="navbar">
          <div class="container-fluid">
              ...
              <div id="nav-option">
                <h3 class="dropdown mt-3">
                  ...
                  >
                    ...
                    <li>
                      <Link to="/c-language"> <a class="dropdown-item">
                        C language
                      </a></Link>
                    </li>
                    <li>
                ...
                <Link to='/contact-us' ><h3 class="btn mt-3">Contact Us</h3></Link>
                <h3 class="btn mt-3">About Us</h3>
              </div>
            </div>
            ...
            >
              <span id="menu-btn" className="material-icons">
                menu
              </span>
            </button>
            ...
            >
              <div class="offcanvas-header">
                <h1 id="offcanvasRightLabel" className="ml-2 bg-">Menu</h1>
                <button
                  type="button"
              ...
              <div class="offcanvas-body">
                ...
                <h6 class="mt-3 mb-1 ml-2 py-2 border-bottom border-top rounded-lg">
                <Link to='/contact-us'>Contact Us</Link>
                </h6>
                <h6 class="mt-3  py-2 border-bottom border-top">About Us</h6>
              </div> 
            </div>
          </div>
        </nav>
